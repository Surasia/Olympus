...
from . headers.data_reference_table import DataReference

#from tag_reader.readers.reader_factory import ReaderFactory
from . tag_instance import TagInstance
from . tag_reader_utils import getStringsByRef, readStringInPlace
from . tag_layouts import TagLayouts
from . var_names import getStrInMmr3Hash, getMmr3HashFromInt, TAG_NAMES
...
class TagRef(TagInstance):
    ...
    def readIn(self, f: BinaryIO, header=None):
        ...
        self.ref_id_sub = self.ref_id_sub.hex().lower()
        ...
        self.ref_id_center = self.ref_id_center.hex().lower()
