...
class ImportCoating(bpy.types.Operator, bpy_extras.io_utils.ImportHelper):
    ...
    def readTexture(self, context, texturepath):
        hex_bytes = bytes.fromhex(str(texturepath))
        reversed_bytes = hex_bytes[::-1]
        reversed_hex_string = reversed_bytes.hex()
        texturepath = reversed_hex_string.lower()
        ...
        # If the image is None, flip the endianness of texturename
        return img
            ...
            if ob.type == "MESH": 
                for mat_slot in ob.material_slots: 
                    if mat_slot.material.node_tree:
                        ...
                        path = f"{self.materialuserpath}{materialname}.json"
                        ...
                        if hmmmh: # If material has no style, skip!
                            ...
                            materialstylename = currentmaterial.get("style info")[0]["material style"]["Value"]["Ref_id_str"]
                            ...
                            if materialstylename == materialstyleselection:
                                ...
                                for materialparameters in matparams: 
                                    if materialparameters['parameter name']['Value'] == 523899303: 
                                        ...
                                        normalmap = materialparameters['bitmap']['Value']['Ref_id_str']
                                    elif materialparameters['parameter name']['Value'] == -447337164:
                                        asgtexture = materialparameters['bitmap']['Value']['Ref_id_str']
                                    elif materialparameters['parameter name']['Value'] == -1869712910:
                                        mask0 = materialparameters['bitmap']['Value']['Ref_id_str']
                                        mask1 = materialparameters['bitmap']['Value']['Ref_id_str']
